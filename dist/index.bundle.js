...
addEventListener('DOMContentLoaded', () => {
  ...
  if (emptyLocalStorage) {
    (0,_ui__WEBPACK_IMPORTED_MODULE_2__.addDefaultProjects)();
    (0,_ui__WEBPACK_IMPORTED_MODULE_2__.initiateTodoListListeners)();
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.initiateLS)();
  } else {
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.renderLS)();
    (0,_ui__WEBPACK_IMPORTED_MODULE_2__.initiateTodoListListeners)();
  }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initiateLS": () => (/* binding */ initiateLS),
/* harmony export */   "renderLS": () => (/* binding */ renderLS),
...
const initiateLS = () =>
  localStorage.setItem('projects', JSON.stringify(_ui__WEBPACK_IMPORTED_MODULE_1__.todoList.projects));

function renderLS() {
  const projectsLS = JSON.parse(localStorage.getItem('projects'));

  projectsLS.forEach(project => Object.setPrototypeOf(project, new _project__WEBPACK_IMPORTED_MODULE_0__["default"]()));

  _ui__WEBPACK_IMPORTED_MODULE_1__.todoList.projects = projectsLS;

  (0,_ui__WEBPACK_IMPORTED_MODULE_1__.renderProjectEls)();
}
...
class Todo {
  ...
  constructor(title, desc, date, isImportant = false) {
    ...
    this.desc = desc;
    this.date =
      date.length === 0 ? 'No Date' : (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(date), 'MM/dd/yyyy');
...
class TodoList {
  ...
  addProject(title) {
    this.projects.push(new _project__WEBPACK_IMPORTED_MODULE_0__["default"](title));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addDefaultProjects": () => (/* binding */ addDefaultProjects),
/* harmony export */   "initiateTodoListListeners": () => (/* binding */ initiateTodoListListeners),
/* harmony export */   "renderProjectEls": () => (/* binding */ renderProjectEls),
...
const todoList = new _todoList__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
function initiateTodoListListeners() {
...
function addImportantBtnListener() {
  ...
  importantBtn.addEventListener('click', () => {
    ...
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_5__.updateLS)();
  });
}
